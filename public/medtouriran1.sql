...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2019 at 03:32 PM
...
(109, 17, 'about', 'rich_text_box', 'About', 0, 0, 1, 1, 1, 1, '{}', 6),
(110, 17, 'testimonal', 'rich_text_box', 'Testimonal', 0, 0, 1, 1, 1, 1, '{}', 7),
...
(208, 17, 'education', 'code_editor', 'Education (json format)', 0, 0, 1, 1, 1, 1, '{\"validation\":{\"rule\":\"json\"}}', 4),
(209, 17, 'skills', 'code_editor', 'Skills (json format)', 0, 0, 1, 1, 1, 1, '{\"validation\":{\"rule\":\"json\"}}', 5);
...
(4, 'categories', 'categories', 'Category', 'Categories', 'voyager-categories', 'TCG\\Voyager\\Models\\Category', NULL, NULL, NULL, 1, 0, '{\"order_column\":\"order\",\"order_display_column\":\"title\"}', '2018-12-15 19:38:02', '2019-01-19 17:32:07'),
...
(17, 'doctors', 'doctors', 'Doctor', 'Doctors', NULL, 'App\\Models\\Doctor', NULL, NULL, NULL, 1, 0, '{\"order_column\":\"order\",\"order_display_column\":\"name\"}', '2019-02-08 19:01:07', '2019-07-02 07:58:04'),
...
CREATE TABLE `doctors` (
  ...
  `testimonal` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(386, 'doctors', 'about', 12, 'ar', '<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\"><span style=\"box-sizing: border-box; margin: 0px; padding: 0px; border: 0px; outline: none; font-weight: bolder;\">التخصصات</span></p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\">الدكتور اکبر مهرافزان طبيب الانف الاذن و الحنجرة (جراح الرأس و الرقبة )</p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\"><span style=\"box-sizing: border-box; margin: 0px; padding: 0px; border: 0px; outline: none; font-weight: bolder;\">التعليم والتدريب</span></p>\n<p style=\"direction: rtl; box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\">&nbsp; دورة جراحة تنظير الأنف والجيوب الأنفية من جامعة بافيا (إيطاليا) مستشفى سان ماتيو تحت إشراف الأمين العام للجمعية الأوروبية لجراحة المناظير (البروفيسور كاستل نوف)</p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\"><span style=\"box-sizing: border-box; margin: 0px; padding: 0px; border: 0px; outline: none; font-weight: bolder;\">الخبرة و شهادات مجلس</span></p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\">إنه واحد من الأطباء الأوائل في إيران الذين يتمتعون بتجربة واسعة وكاملة في التنظير والأورام الحميدة الأنفية</p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\">أجرى اكثر من 1000 عملية تجميل الانف و الجراحة</p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\">كما ان له نشاط في المؤتمرات الدولية في ايران و اروبا فلهذا هو على دراية بأحدث أساليب الاجراءات في هذا المجال&nbsp;&nbsp;</p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\"><span style=\"box-sizing: border-box; margin: 0px; padding: 0px; border: 0px; outline: none; font-weight: bolder;\">العضويات المهنية</span></p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\">الجمعية الايرانية لامراض الانف&nbsp;</p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\">(RRS) جمعية ابحاث الأنف</p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\"><span style=\"box-sizing: border-box; margin: 0px; padding: 0px; border: 0px; outline: none; font-weight: bolder;\">اللغات</span></p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\">الانجليزية</p>\n<p style=\"box-sizing: border-box; margin: 0px 0px 1rem; padding: 0px; border: 0px; outline: none; color: #656464; font-family: kufi; font-size: 13px; text-align: right;\">الفارسية&nbsp;</p>', '2019-05-12 09:11:32', '2019-05-12 10:06:49'),
