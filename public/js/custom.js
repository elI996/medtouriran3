...
(function ($) {
    ...
    $('body').on('click', '#menu-bar', function () {
        var menu = $('.menu');
        $('#menu-bar').addClass('mobile-menu-close');
        $('#menu-bar a i').addClass('fa-times');
        $('#menu-bar a i').removeClass('fa-bars');
    ...
    $('body').on('click', '.mobile-menu-close', function () {
        var menu = $('.menu');
        $('#menu-bar').removeClass('mobile-menu-close');
        $('#menu-bar a i').addClass('fa-bars');
        $('#menu-bar a i').removeClass('fa-times');
